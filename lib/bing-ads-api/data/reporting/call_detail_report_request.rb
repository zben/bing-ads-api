...
module BingAdsApi
	...
	# === Usage
	#   
	#   request = BingAdsApi::CallDetailReportRequest.new(
	#     :format   => :xml,
	#     :language => :english,
	...
	#     :time => :this_week)
	#   
	#   request2 = BingAdsApi::CallDetailReportRequest.new(
	#     :format   => :csv,
	#     :language => :french,
	#     :report_name => "Me report",
	#     :aggregation => :daily,
	...
	#     )
	class CallDetailReportRequest < BingAdsApi::PerformanceReportRequest
		...
		private
			...
			# Author:: jlopezn@neonline.cl 
			# 
			# Returns:: "v9:CallDetailReportRequest"
